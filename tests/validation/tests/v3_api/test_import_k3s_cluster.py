...
def create_multiple_control_cluster():
    ...
    if RANCHER_EXTERNAL_DB == "MariaDB":
        RANCHER_EXTERNAL_DB_VERSION = RANCHER_EXTERNAL_DB_VERSION or "10.3.20"
        RANCHER_DB_GROUP_NAME = RANCHER_DB_GROUP_NAME or "mariadb10.3"
    elif RANCHER_EXTERNAL_DB == "aurora-mysql":
        RANCHER_EXTERNAL_DB_VERSION = (
            RANCHER_EXTERNAL_DB_VERSION or "5.7.mysql_aurora.2.09.0"
        )

        RANCHER_DB_GROUP_NAME = RANCHER_DB_GROUP_NAME or "aurora-mysql5.7"
    elif RANCHER_EXTERNAL_DB == "postgres":
        RANCHER_EXTERNAL_DB_VERSION = RANCHER_EXTERNAL_DB_VERSION or "11.5"
        RANCHER_DB_GROUP_NAME = RANCHER_DB_GROUP_NAME or "postgres11"
    else:
        RANCHER_EXTERNAL_DB_VERSION = RANCHER_EXTERNAL_DB_VERSION or "5.7"
        RANCHER_DB_GROUP_NAME = RANCHER_DB_GROUP_NAME or "mysql5.7"
...
def create_rancher_cluster(client, k3s_clusterfilepath):
    clustername = CLUSTER_NAME or random_test_name("testcustom-k3s")
